        ...
        <div>
          {globalVariable !== '' ? (
            <div className="flex h-[100%]">
              <div
                className={activeMenu === 'mypage' ? 'active' : 'non-active'}
                onClick={() => handleLoginClick('/mypage', 'mypage')}
              >
                마이페이지
              </div>
            </div>
            ...
            <div
              className={activeMenu === 'login' ? 'active' : 'non-active'}
              onClick={() => handleLoginClick('/login', 'login')}
            >
              로그인
            </div>
          )}
